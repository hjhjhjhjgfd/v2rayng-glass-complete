...
import com.v2ray.ang.compose.GlassBackdrop
...
fun MainScreen(
    ...
    ModalNavigationDrawer(
      ...
      Box(modifier = Modifier.fillMaxSize()) {
        // Decorative blurred backdrop that the translucent glass panels
        // (top bar, bottom bar, tab bar, server cards) reveal through.
        GlassBackdrop(isDarkTheme = isDarkTheme, modifier = Modifier.fillMaxSize())
